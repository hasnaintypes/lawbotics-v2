        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {document.effectiveDate && (
            <div className="space-y-2">
              ...
              <p className="text-sm font-medium">{new Date(document.effectiveDate).toLocaleDateString()}</p>
            </div>
          )}
          ...
          {document.expirationDate && (
            <div className="space-y-2">
              ...
              <p className="text-sm font-medium">{new Date(document.expirationDate).toLocaleDateString()}</p>
            </div>
          )}
        </div>
