 ...
 */
export function ContractBasicInfo({ formData, onUpdate }: ContractBasicInfoProps) {
  /**
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div>
        ...
        <Select value={formData.type} onValueChange={(value) => onUpdate({ type: value as any })}>
      ...
      <div>
        ...
        <Select value={formData.priority} onValueChange={(value) => onUpdate({ priority: value as any })}>
          <SelectTrigger className="mt-1.5 rounded-xl">
      ...
      <div>
        ...
        <Input
          ...
          onChange={(e) => onUpdate({ value: Number.parseFloat(e.target.value) || undefined })}
          placeholder="0.00"
          className="mt-1.5 rounded-xl"
        />
      </div>
